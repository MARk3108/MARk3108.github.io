document.addEventListener("DOMContentLoaded", () => {
  ...
  const questSteps = [
    ...
    {
      title: "⛸️Место, где ты сможешь скрутить четверной тулуп⛸️",
      clue:
        "Финал. Ты + коньки + камера = великий момент.",
      badge: "⑤",
      badgeClasses: "bg-pink-500/30 border border-pink-300/30",
      btnText: "Сделай фото в своем коронном элементе, если получится поймать лучшее скольжение — всё, ты победила этот квест официально →",
    },
  ];
